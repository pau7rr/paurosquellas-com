...
<template>
  <header class=" ">
      <nav class=" h-20 w-full grid grid-cols-2 content-center">
          ...
          <div class=" hidden md:flex justify-center items-center gap-x-3 text-slate-900">  
      ...
      <div class=" md:hidden flex p-3 border-2 border-slate-900 justify-center gap-x-10 font-mono text-gray-100 underline underline-offset-8 bg-slate-900">
        <RouterLink to="/about" class=""><p class="">About</p></RouterLink>
        <RouterLink to="/about" class=""><p class="">Projects</p></RouterLink>
        <RouterLink to="/about" class=""><p class="">Contact</p></RouterLink>
      </div>
  </header>
</template>
